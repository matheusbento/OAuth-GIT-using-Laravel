...
<head>
  ...
  <link href="<?php echo e(URL::asset('css/page-center.css')); ?>" rel="stylesheet">
...
<body class="cyan" ng-controller="GitHubController">
			        ...
			        <div class="input-field col s12 center">
					    <ul id="projects-collection" class="collection z-depth-1">
							...
							<li class="collection-item">
							    <div class="row">
								  	<input type="text" id="loginText" style="display:none;" ng-model="loginText" value="<?php echo e($user->user['login']); ?>"/>
	...
	<script src="<?php echo e(URL::asset('js/AngularControllerShowInfo.js')); ?>" rel="script"></script>
</body>
